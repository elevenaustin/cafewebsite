      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
        <div className="max-w-2xl">
          ...
          <div className="inline-flex items-center gap-2 mb-4">
            <span className="text-xs sm:text-sm font-semibold uppercase tracking-[0.25em] text-[#c89355]">
              {CAFE.heroSubtitle}
            </span>
          </div>

          {/* Main Title */}
          <h1 className="font-serif text-5xl sm:text-6xl md:text-7xl lg:text-8xl font-normal leading-[1.08] tracking-tight mb-6">
            <span className="block text-[#f4efe9]">{CAFE.heroTitle1}</span>
            <span className="block text-[#c89355] italic">{CAFE.heroTitle2}</span>
          </h1>
